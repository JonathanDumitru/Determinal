# Determinal - Simplified Menu Bar Quick Reference
...
## 🖱️ Menu Bar (Right-Click)

The menu bar icon is your primary control center:

```
┌─────────────────────────────┐
│ ▣ Show Terminal            │ ← Click to show/hide
├─────────────────────────────┤
│ Clear Terminal        ⌘K    │
│ Show Status           ⌘I    │
├─────────────────────────────┤
...
│ About Determinal           │
├─────────────────────────────┤
│ Quit Determinal            │ ← Only way to fully quit
└─────────────────────────────┘
```
...
### Tip 5: Red X Button
Clicking the window's close button (⭕️) hides the window—it doesn't quit!
```
⭕️ ⚫️ 🟢  ← Red X = Same as ⌘Q
```
...
A: Right-click the menu bar icon and select "Quit Determinal"

**Q: Why can't I use ⌘⇧Q to quit anymore?**
...
- ⌘⇧Q to quit
- ⌘⇧` to toggle
- Two similar shortcuts with SHIFT
...
Type `help` in the terminal for complete command list.
